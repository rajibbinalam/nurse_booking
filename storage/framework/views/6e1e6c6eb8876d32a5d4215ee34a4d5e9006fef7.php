                        ...
                        <div class="row clearfix">
                           <div class="col-lg-12 col-md-6 col-sm-12 form-group">
                              <figure class="image-box" style="    margin-bottom: 15px;">
                                 ...
                                 <img src="<?php echo e(asset('upload/profile/').'/'.$userdata->profile_pic); ?>" alt="" height="200" width="200">
                                 <?php else: ?>
                                 <img src="<?php echo e(asset('upload/profile/profile.png')); ?>" alt="">
                                 <?php endif; ?>
                              </figure>
                           ...
                           <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                              ...
                              <select name="gender" class="form-control" id="">
                                ...
                                <option value="male" <?php echo e($userdata->gender == 'male' ? 'selected' : ''); ?>>Male</option>
                                <option value="female" <?php echo e($userdata->gender == 'female' ? 'selected' : ''); ?>>Female</option>
                                <option value="other" <?php echo e($userdata->gender == 'other' ? 'selected' : ''); ?>>Other</option>
                            </select>
                           </div>
                        </div>
                  </div>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\doctor_find\resources\views/user/patient/editprofile.blade.php ENDPATH**/ ?>