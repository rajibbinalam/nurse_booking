                      ...
                      <table id="myTable" class="table table-bordered dt-responsive tablels">
                         ...
                         <tbody>
                            ...
                            <tr>
                                ...
                                <td> <img src="<?php echo e(asset('upload/doctors/')); ?>/<?php echo e($doc->image); ?>" alt="" width="100px;"> </td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rutik\live\bookappointment\resources\views/admin/report/doctor.blade.php ENDPATH**/ ?>
