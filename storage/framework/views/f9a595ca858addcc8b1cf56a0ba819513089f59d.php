                       ...
                       <?php echo e(csrf_field()); ?>
                                    ...
                                    <div class="profile-title">
                                        <figure class="image-box">
                                          ...
                                          <?php if($doctordata->image!=""): ?>
                                             <img src="<?php echo e(asset('upload/doctors').'/'.$doctordata->image); ?>" alt="" accept="image/*">
                                          <?php else: ?>
                                             <img src="<?php echo e(asset('front_pro/assets/images/resource/profile-2.png')); ?>" alt="" >
                                          <?php endif; ?>
                                       </figure>
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                               ...
                                               <input type="number" required name="consultation_fees" value="<?php echo e(isset($doctordata->consultation_fees)?$doctordata->consultation_fees:''); ?>" class="form-control" id="consultation_fees" min="1" step="0.01" >
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-md-6 col-sm-12 form-group">
                                                <label><?php echo e(__('message.Facebook Url')); ?></label>
                                                <input type="text" name="facebook_url" id="facebook_url" placeholder="<?php echo e(__('message.Enter Facebook Url')); ?>" required="" value="<?php echo e(isset($doctordata->facebook_url)?$doctordata->facebook_url:''); ?>">
                                            </div>
                                            <div class="col-lg-12 col-md-6 col-sm-12 form-group">
                                                <label><?php echo e(__('message.Twitter Url')); ?></label>
                                                <input type="text" id="twitter_url" name="twitter_url" placeholder="<?php echo e(__('message.Enter Twitter Url')); ?>" required="" value="<?php echo e(isset($doctordata->twitter_url)?$doctordata->twitter_url:''); ?>">
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                                ...
                                                ="services" placeholder="<?php echo e(__('message.Enter Description about Services')); ?>"><?php echo e(isset($doctordata->services)?$doctordata->services:''); ?></textarea>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 form-group">
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rutik\live\bookappointment\resources\views/user/doctor/editprofile.blade.php ENDPATH**/ ?>
