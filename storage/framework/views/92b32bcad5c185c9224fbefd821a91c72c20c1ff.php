            ...
            <div class="team-block-two wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
               <div class="inner-box">
                  ...
                  <figure class="image-box">
                     <img src="<?php echo e(asset('upload/doctors').'/'.$dl->image); ?>" alt="" style="height: 185px;">
                     <?php if($dl->is_fav=='0'): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment_old/resources/views/user/home.blade.php ENDPATH**/ ?>
