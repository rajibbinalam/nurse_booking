                ...
                <div class="custom-all-timing-main-box">
                    <form action="{{url('updatedoctortiming')}}" method="post">
                        ...
                        <ul class="accordion-box">
                            ...
                            @for($i=0;$i<7;$i++) <li class="accordion block ">
                                <div class="acc-btn">
                                            ...
                                            <div class="form-widget">
                                                <div class="form-inner">
                                                    <div class="appointment-time">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" name="arr[{{$i}}][duration][]" id="duration_{{$i}}_{{$j}}" value="{{ $d->duration }}" readonly>
                                                        </div>
                                                        {{-- <div class="custom-dropdown" id="timerange" >
                                                                ...
                                                                <?php
                                                                                // echo html_entity_decode($d->options);
                                                                                ?>
                                                                </select>
                                                            </div> --}}

                                                    <div class="total_work_tim" id="total_work_tim{{ $i }}" style="">Total Duration: {{ $d->duration }} Hourse</div>
                                                    {{-- @if($j!=0)
                                            ...
                                            <div class="form-inner">
                                                <div class="appointment-time">
                                                    ...
                                                    {{-- <div class="custom-dropdown" id="timerange" >
                                                        ...
                                                        <option value="">{{__("message.Select Duration")}} TmP</option>
                                                        </select>
                                                    </div> --}}
                                                    <div class="form-group">
                                                        <input type="text" name="arr[{{$i}}][duration][]" id="duration_{{$i}}_0" readonly>
                                                    </div>
                                                    <div class="total_work_tim" id="total_work_tim{{ $i }}" style=""></div>
                                                    <div class="slot-doctor-profile-main-box">
                                                    <ul id="slot_{{$i}}_0">
